...
Mercury jest nowoczesnym, logiczno-funkcyjnym językiem programowania,
który łączy jasność i pełnię wyrazu programowania deklaracyjnego z
rozszerzonymi możliwościami statycznej analizy i wykrywania błędów.
Bardzo zoptymalizowany algorytm wykonywania daje o wiele większą
wydajność niż istniejące systemy programowania logicznego, i prawie
tak dużą, jak konwencjonalne systemy. Mercury wychodzi naprzeciw
problemom tworzenia oprogramowania na dużą skalę, pozwalając na
modularność, oddzielną kompilację i liczne optymalizacje.

Ten pakiet zawiera kompilator, profiler, debugger, dokumentację itp.
Nie zawiera zestawu "extras", który jest dostępny z
